...
public class storeinfo_west2 extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView storeinfo_west2_text_storename, storeinfo_west2_text_storenumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_storeinfo_west2);

        storeinfo_west2_text_storename = findViewById(R.id.storeinfo_west2_text_storename);
        storeinfo_west2_text_storenumber = findViewById(R.id.storeinfo_west2_text_storenumber);
        storeinfo_west2_img_west1 = findViewById(R.id.storeinfo_west2_img_west1);

        Intent intent = getIntent();
        String name = intent.getStringExtra("name");
        String number= intent.getStringExtra("number");
        String img = intent.getStringExtra("img");
        int Listcount = intent.getIntExtra("List_count",13);
        Glide.with(this).load(img).into(storeinfo_west2_img_west1);
        storeinfo_west2_text_storename.setText(name);
        storeinfo_west2_text_storenumber.setText(number);
        ...
        storeinfo_west2_btn_mirror = (ImageButton) findViewById(R.id.storeinfo_west2_btn_mirror);
        storeinfo_west2_btn_back = (ImageButton) findViewById(R.id.storeinfo_west2_btn_back);



        storeinfo_west2_btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        storeinfo_west2_btn_mirror.setClickable(true);  // 오른쪽 상당에 결제하기로 넘어가는 코드 - 서강호
        storeinfo_west2_btn_mirror.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        databaseReference = database.getReference("List_west/list2/Store_west2");
